describe('It should validate cypress react selector', () => {
  ...
  it.skip('it should validate react selection component and props', () => {
    cy.react('t', { props: { name: '5' } }).should('have.text', '5');
  });

  it.skip('it should validate react selection with wildcard', () => {
    cy.react('*', { props: { name: '9' } }).should('have.text', '9');
  });

  it.skip('it should validate react selection with cypress find command', () => {
    cy.react('t', { props: { name: '5' } })
      .find('button')
      .should('have.text', '5');
  });

  it.skip('should calculate 7 * 6', () => {
  ...
  it.skip('it should validate getProps with specific prop name', () => {
    cy.getReact('t', { props: { name: '5' } })
      .getProps('name')
      .should('eq', '5');
  });

  it.skip('it should validate getProps with no specific prop name', () => {
    cy.getReact('t', { props: { name: '5' } })
      .getProps()
      .then((props) => {
  ...
  it.skip('it should validate chained react instances getProps with specific prop name', () => {
    cy.getReact('t')
